                            ...
                            <form role="form" action="alterarAdministrador.html" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-xs-8">
                                        <input class="form-control" type="text" value="${administrador.nome}" placeholder="Digite seu Nome" required="true" name="nome" id="nome" maxlength="40" pattern="[a-ZA-Zá-úÁ=Ú\s]+$" title="Apenas letras!">
                                    </div>
                                </div>
                                <div class="form-group row">
