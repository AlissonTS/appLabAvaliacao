                               ...
                               <form role="form" action="alterarEstabelecimentoAdm.html" method="POST">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" type="text" value="${estabelecimento.nome}" placeholder="Digite o nome do Estabelecimento" required="true" name="nome" id="nome" maxlength="25">
                                        </div>
                                    </div>
                                    <div class="form-group row">
