                    ...
                    <div class="row" style="margin-left: 0px; margin-right: 0px">
                        <div class="col-md-offset-3 col-md-6 col-xs-12">
                            ...
                            <c:if test="${not empty cliente}">
                                <form role="form" action="alterarCliente.html" method="POST">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" value="${cliente.nome}" type="text" placeholder="Digite seu Nome" required="true" name="nome" id="nome" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cpf" class="col-md-3 col-xs-4 col-form-label">CPF: </label>
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" value="${cliente.cpf}" type="text" placeholder="###.###.###-##" required="true" name="cpf" id="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="###.###.###-##">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="telCel" class="col-md-3 col-xs-4 col-form-label">Telefone Celular:</label>
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" value="${cliente.telCel}" type="text" placeholder="(##) #####-####" required="true" name="telCel" id="telCel" pattern="\([0-9]{2}\)[\s][0-9]{5}-[0-9]{4}" title="(##) #####-####">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email" class="col-md-3 col-xs-4 col-form-label">Email: </label>
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" value="${cliente.email}" type="text" placeholder="Digite o email do cliente" required="true" name="email" id="email" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <c:if test="${empty cliente}">
                                <br><p class="text-center" style="font-size: 15px"><strong>Nenhum cliente selecionado para alteração!</strong></p>
                            </c:if>    
                        </div>
                    </div>
                </div>                 
