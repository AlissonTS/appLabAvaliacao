                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="menu">
                            <ul class="nav navbar-nav">
                              ...
                              <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Gerenciamento de Estabelecimentos</a>
                            ...
                            <form role="form" action="alterarAdministrador.html" method="POST" style="font-size: 16px;">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-xs-8">
                                        <input class="form-control" style="height: 50px;" type="text" value="${administrador.nome}" placeholder="Digite seu Nome" required="true" name="nome" id="nome" maxlength="40" pattern="[a-ZA-Zá-úÁ=Ú\s]+$" title="Apenas letras!">
                                    </div>
                                </div>
                                <div class="form-group row">
