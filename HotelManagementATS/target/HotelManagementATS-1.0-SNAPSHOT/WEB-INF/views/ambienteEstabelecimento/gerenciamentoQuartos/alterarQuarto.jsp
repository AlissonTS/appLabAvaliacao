                    ...
                    <div class="row" style="margin-left: 0px; margin-right: 0px">
                        <div class="col-md-offset-3 col-md-6 col-xs-12">
                                ...
                                <form role="form" action="alterarQuarto.html" method="POST" style="font-size: 16px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" style="height: 50px;" value="${quartoEscolhido.numero}" type="text" placeholder="Digite o número de identificação do quarto" required="true" name="numero" id="numero" maxlength="4" pattern="[0-9]+$" title="Apenas Números">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="area" class="col-md-3 col-xs-4 col-form-label">Área do quarto (m²): </label>
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" style="height: 50px;" value="${quartoEscolhido.area}" data-thousands="" data-decimal="."  type="text" placeholder="Digite a área do quarto" required="true" name="area" id="area" maxlength="7">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input class="form-control" style="height: 50px;" value="${quartoEscolhido.valorDiaria}" data-thousands="" data-decimal="." type="text" placeholder="Digite o valor a ser cobrado pela diária" required="true" name="valorDiaria" id="valorDiaria" maxlength="6">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="descricaoExtra" class="col-md-3 col-xs-4 col-form-label">Informações extras sobre o quarto (Não obrigatório): </label>
                                        <div class="col-md-8 col-xs-8">
                                            <textarea class="form-control" style="height: 50px;" rows="5" id="descricaoExtra" name="descricaoExtra" maxlength="60">${quartoEscolhido.descricaoExtra}</textarea>
                                        </div>
                                    </div><!--
                                    <div class="form-group row">
                            ...
                            <c:if test="${empty quartoEscolhido}">
                                <br><p class="text-center" style="font-size: 16px"><strong>Nenhum quarto selecionado para alteração!</strong></p>
                            </c:if>    
                        </div>
                    </div>
                </div>                 
