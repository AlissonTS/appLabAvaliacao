...
<html>
    <head>
        <title>Operadores Cadastrados - ATS-HM</title>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown">Gerenciamento de Operadores <span class="caret"></span></a>
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li class="active"><a href="operadoresCadastrados.html">Operadores Cadastrados</a></li>
                                    </ul>
                                </li>
                ...
                <div class="container-fluid" style="margin-bottom: 3%">
                    <div class="row" style="margin-left: 0px; margin-right: 0px">
                        <div class="col-md-offset-1 col-md-10 col-xs-12">
                            ...
                            <h2 class="text-center" style="font-size: 28px;">Operadores Cadastrados</h2>
                            <br>
